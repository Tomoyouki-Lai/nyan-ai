...
| **花費時間**       | 慢，每次重頭分析，需要 10-20 分鐘              | 快，重用他人流程腳本，1 分鐘內可完成      |
...
- 導航與獎勵功能：適用於指引使用者完成多步驟任務並在完成後發放獎勵
- 個人伴侶：適用於情感互動、日常陪伴與個人化提醒
- 服務介紹：適用於講解平台功能或引導使用者體驗服務 → cards/customer support-template.json
- 產品展示：適用於呈現商品特點、規格與吸引購買行為
