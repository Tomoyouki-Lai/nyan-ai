...
> 喵助手（Nyan agent）是您網路世界的貼身夥伴、管家與助手。

喵助手提供聊天模式 工作模式兩種模式，基於需要自由切換。：

聊天模式：

工作模式： 
- 喵助手能夠判斷使用哪一種貓卡，然後推薦給玩家，用戶體驗可以無縫銜接。 -
- 玩家可以手動啟動（點擊貓卡兩次），給予玩家完全的自由度。

---

## 🎴 什麼是喵卡（Nyan Card）？

> 喵卡不只是工具，更是**溝通、推廣與共創**的管道。

喵卡是一個微型 AI 助手，是一種可視化、可分享的網頁任務腳本。喵卡具備以下特色：
...
2. **使用 .json 檔喵卡** → 經由自行製作或私下交換取得.json 檔，然後直接從你的電腦桌面拖曳 .json 檔到喵咪身上載入！這讓你可以透過私下分享、社群、雲端等方式傳送喵卡給朋友喔！
